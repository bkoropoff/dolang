...
use crate::{
    ...
    sym::{self, Sym},
    unpack,
    value::{BinEmbryo, Output, Slot, Value},
    vm::Vm,
};
    ...
    fn op_inspect<'a>(_this: Recv<'v, 'a, Self>, _vm: &Vm<'v>) -> Option<Inspect<'v, 'a>> {
        Some(Inspect {
            ...
            members: vec![
                ...
                Sym::well_known(sym::APPEND),
                Sym::well_known(sym::PUSH),
                Sym::well_known(sym::EXTEND),
                Sym::well_known(sym::INSERT),
                Sym::well_known(sym::REMOVE),
                Sym::well_known(sym::TRUNCATE),
                Sym::well_known(sym::CLEAR),
                Sym::well_known(sym::FREEZE),
